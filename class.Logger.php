...
class Logger {
  ...
  //Note: private constructor.  Class uses the singleton pattern
   private function __construct() {
    ...
    //ARRAY ASOCIATIVO CON EL NIVEL Y EL ARCHIVO
    $cfg = [
        "LOGGER_FILE" => Config::getConfigFile(),
        "LOGGER_LEVEL" => Config::getConfigLevel()
    ];
    echo $cfg['LOGGER_LEVEL'];      //SACO EL NIVEL PARA COMPROBAR
